...
public static class UtilsClass
{
    ...
    public static bool IsPointerOverUI()
    {
        ...
        else
        {
            ...
            pe.position = Mouse.current.position.value;
    ...
    {
        Vector3 vec = GetWorldPositionFromUI(Mouse.current.position.value, Camera.main);
        vec.z = 0f;
        return vec;
    }
    ...
    {
        return GetWorldPositionFromUI(Mouse.current.position.value, Camera.main);
    }

    public static Vector3 GetWorldPositionFromUI(Camera worldCamera)
    {
        return GetWorldPositionFromUI(Mouse.current.position.value, worldCamera);
    }
    ...
    {
        return GetWorldPositionFromUI_Perspective(Mouse.current.position.value, Camera.main);
    }

    public static Vector3 GetWorldPositionFromUI_Perspective(Camera worldCamera)
    {
        return GetWorldPositionFromUI_Perspective(Mouse.current.position.value, worldCamera);
    }
